...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static double getsqrt(double n1){
       double n3=(double)Math.sqrt(n1);
        return n3;
    }

    public static double getsin(double n1){
        double n2=(double)Math.sin(Math.toRadians(n1));
        return n2;
    }

    public static double getadd(double n1,double n2){
        double n3=n1+n2;
        return n3;
    }
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.add:
                double add_ans = getadd(Double.parseDouble(numb1),Double.parseDouble(numb2));
            ...
            case R.id.sin:
                num2.setText(" ");
                double sin_ans = getsin((Double.parseDouble(numb1)));
                res.setText(String.valueOf(sin_ans));
                break;
            case R.id.cos:
                num2.setText(" ");
                double cos_ans = Math.cos(Math.toRadians(Double.parseDouble(numb1)));
                res.setText(String.valueOf(cos_ans));
                break;
            case R.id.tan:
                num2.setText(" ");
                double tan_ans = Math.tan(Math.toRadians(Double.parseDouble(numb1)));;
                res.setText(String.valueOf(tan_ans));
                break;
            case R.id.sqrt:
                num2.setText(" ");
                double sq_ans = getsqrt(Double.parseDouble(numb1));
